...
- [MOTHODS](#mothods)
  ...
  - [Keep the colors mapping for reuse
    elsewhere](#keep-the-colors-mapping-for-reuse-elsewhere)
...
We can use the viremia duration (Kumar et al., 2003) bar plot (make sure
to reference sources!!!) to illustrate the potential importance of house
finches in WNV transmission and as the logical foundation for our
hypothesis that house finches serve as amplifying hosts for WNV and the
prediction that locations with more house finches in our blood host
...
<img src="Warm-up-mosquitoes-RyanColqui_files/figure-gfm/viremia-1.png" style="display: block; margin: auto auto auto 0;" />
...
If the House finch is the amplifying host for WNV, we can predict that
...
<img src="Warm-up-mosquitoes-RyanColqui_files/figure-gfm/horiz-plot-1.png" style="display: block; margin: auto auto auto 0;" />
